...
/** define the Deck API, to draw a card at a time */
...
/** have to define async function within a function */
    ...
    /** Draw card: change state and trigger the effect */
    async function draw() {
        try {
    ...
    /** Shuffle: change the state and trigger the effect */
    ...
    /** Return shuffle button (disabled if shuffling) */
